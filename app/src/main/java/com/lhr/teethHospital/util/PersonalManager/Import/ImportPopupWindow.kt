package com.lhr.teethHospital.util.PersonalManager.Import
...
import com.lhr.teethHospital.util.EditPatientInformation.EditPatientInformationActivity
...
class ImportPopupWindow(mContext: Context, personalManagerFragment: PersonalManagerFragment) : PopupWindow(), View.OnClickListener {
    ...
    init {
        ...
        buttonImportSingle = view.findViewById(R.id.buttonImportSingle)
        // 外部可點擊
    ...
    fun importMore() {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.Q) {
            ...
            ActivityCompat.startActivityForResult(mainActivity, pickIntent, Model.IMPORT_CSV, null)
        }
